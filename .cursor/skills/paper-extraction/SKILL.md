...
- Keep **measurement**, **author interpretation**, and **your possible explanation** on separate lines. Do not merge them into one "finding."
- If the paper states a **mechanism**, record whether it was **directly measured**, **proposed**, or **cited from earlier work**. Downstream `article.md` may not upgrade that grade (`scientific-synthesis`).
