...
5. **Abstract and title.** No `[n]`, no *et al.*, no stack of effect sizes. No Scopus, “open full texts”, year window of the export, or paywall talk — that is Methods only. No *First, Second, Third* or *(i)(ii)(iii)* as the argument spine. Title is `Topic: a narrative review of …` (or the matching kind). See `review-prose` (Continuous prose).
