# Memory index — pick one card

Match the **user’s field** (and review kind) to a card. If two cards fit, use both: the generic narrative rules plus the closest field card. Record the choice in `structure-benchmark.md`.

| User field / keywords | Card | In-repo worked example (form, not evidence) |
|---|---|---|
| default; unknown field; “I am new” | [`generic-narrative.md`](generic-narrative.md) | craft notes + fictional [`examples/sample-article.md`](../../examples/sample-article.md) |
...
**Kind overlay** (from the craft study, not from a disease area):

- User asked for a **systematic review / meta-analysis** → IMRaD Results, structured abstract. Do not use the narrative spines below as the outline.
- User asked for a **short note** → `--short`; skip field-structure-benchmark.
- Default → **narrative with brief Methods**, thematic `##` after Methods, separate Discussion.
---
